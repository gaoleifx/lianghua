# -*- coding: utf-8 -*-
"""掘金量化模拟盘入口。账户凭据由Windows用户环境变量注入。"""
import os, sys
...
def init(context):
    ...
    if not context.account_id: raise RuntimeError("请设置GOLDMINER_SIM_ACCOUNT模拟账户")
...
if __name__ == "__main__":
    ...
    run(strategy_id=user_environment("GM_SIM_STRATEGY_ID", "08196542-1ba7-11f1-8c86-107c6107318f"),
